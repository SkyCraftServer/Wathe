...
public class MapVariablesWorldComponent implements AutoSyncedComponent {
    ...
    private static List<PosWithOrientation> createDefaultSpawnPositions() {
        ...
        positions.add(new PosWithOrientation(8.5, 122, -537.5, 179, -25));
        positions.add(new PosWithOrientation(17.5, 123, -538.5, 0, 0));
        positions.add(new PosWithOrientation(12.5, 123, -537.5, 0, -15));
        positions.add(new PosWithOrientation(26.5, 122, -537.5, 179, -10));
        positions.add(new PosWithOrientation(36.5, 123, -536.5, 0, 0));
        positions.add(new PosWithOrientation(36.5, 123, -534.5, 179, 0));
        positions.add(new PosWithOrientation(44.5, 122, -535.5, 90, 35));
        positions.add(new PosWithOrientation(48.5, 123, -538.5, 90, 0));
        positions.add(new PosWithOrientation(57.5, 122, -532.5, -90, 0));
        positions.add(new PosWithOrientation(59.5, 122, -535.5, 90, 15));
        positions.add(new PosWithOrientation(61.5, 123, -538.5, 0, 0));
        positions.add(new PosWithOrientation(70.5, 122, -536.5, -50, -15));
        positions.add(new PosWithOrientation(81.5, 123, -537.5, -90, 0));
        positions.add(new PosWithOrientation(83.5, 123, -537.5, 90, 0));
        positions.add(new PosWithOrientation(86.5, 122, -535.5, 179, 35));
        positions.add(new PosWithOrientation(93.5, 123, -533.5, 179, 0));
        positions.add(new PosWithOrientation(96.5, 123, -537.5, 90, 0));
        positions.add(new PosWithOrientation(95.5, 122, -531.5, 0, 0));
        positions.add(new PosWithOrientation(77.5, 122, -535.5, -90, 0));
        positions.add(new PosWithOrientation(107.5, 122, -537.5, -85, -5));
        positions.add(new PosWithOrientation(110.5, 122, -537.5, -90, 50));
        positions.add(new PosWithOrientation(116.5, 122, -535.5, 179, 0));
        positions.add(new PosWithOrientation(113.5, 122, -538.5, -90, 0));
        positions.add(new PosWithOrientation(121.5, 122, -535.5, 179, 0));
        positions.add(new PosWithOrientation(138.5, 123, -537.5, 90, 45));
        positions.add(new PosWithOrientation(136.5, 123, -537.5, -90, 45));
        positions.add(new PosWithOrientation(136.5, 123, -532.5, -90, 45));
        positions.add(new PosWithOrientation(134.5, 123, -534.5, 90, 0));
        positions.add(new PosWithOrientation(146.5, 123, -533.5, 179, 15));
        positions.add(new PosWithOrientation(154.5, 122, -533.5, -90, -2));
        positions.add(new PosWithOrientation(158.5, 122, -533.5, -90, 25));
        positions.add(new PosWithOrientation(164.5, 122, -537.5, 179, 15));
        positions.add(new PosWithOrientation(167.5, 122, -536.5, 0, 0));
        positions.add(new PosWithOrientation(189.5, 125, -538.5, 90, 0));
        positions.add(new PosWithOrientation(178.5, 122, -532.5, 113, 0));
        positions.add(new PosWithOrientation(162.5, 122, -535.5, 179, 0));
